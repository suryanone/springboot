<%@page import="com.wide.spring_boot.model.Product"%>
...
<h1>List Product</h1>
<br/>
<h3><a href="http://localhost:8080/TeamWeb/addProduct">Add Product</a>	|	<a href="http://localhost:8080/TeamWeb/">Home</a></h3>
<h3></h3>
<h3></h3>
<br/>
